...
void StorySonifier::actionListenerCallback(const juce::String& message)
{
	...
	{
		mMainProcessor.scheduleInst(std::make_unique<CWavetableOscillator>(Waveform::sqr, 555, 0.25, mSampleRate), 0, 1);
	}
	else if (message.contains("Encourage"))
	{
		mMainProcessor.scheduleInst(std::make_unique<CWavetableOscillator>(Waveform::sine, 555, 0.25, mSampleRate), 0, 1);
	}
}

void StorySonifier::initializeMemberInstruments(float fSampleRate)
{
	mPieceMelodies[kKingWhite] = std::make_shared<CWavetableOscillator>(Waveform::sine, FREQ::noteToFreq("A4"), 1, fSampleRate); // White King
	mPieceMelodies[kKingBlack] = std::make_shared<CWavetableOscillator>(Waveform::saw, FREQ::noteToFreq("A4"), 1, fSampleRate);
	...
	QueenWhiteChord->constructChord(CWavetableOscillator(Waveform::sine, 440, 1, fSampleRate), QueenNotes, 1, 110);
	QueenBlackChord->constructChord(CWavetableOscillator(Waveform::saw, 440, 1, fSampleRate), QueenNotes, 1, 110);
	...
	KnightWhiteLoop->constructTune(CWavetableOscillator(Waveform::sine, 440, 1, fSampleRate), knightNotes, knightBeats, 2, 110);
	KnightBlackLoop->constructTune(CWavetableOscillator(Waveform::saw, 440, 1, fSampleRate), knightNotes, knightBeats, 2, 110);
	...
	BishopWhiteLoop->constructTune(CWavetableOscillator(Waveform::sine, 440, 1.0, fSampleRate), bishopNotes, bishopBeats, 7, bishopBpm);
	BishopBlackLoop->constructTune(CWavetableOscillator(Waveform::saw, 44, 1, fSampleRate), bishopNotes, bishopBeats, 7, bishopBpm);
	...
	RookWhiteLoop->constructTune(CWavetableOscillator(Waveform::sine, 440, 1, fSampleRate), rookNotes, rookBeats, 6, rookBpm);
	RookBlackLoop->constructTune(CWavetableOscillator(Waveform::saw, 440, 1, fSampleRate), rookNotes, rookBeats, 6, rookBpm);
	...
	PawnWhiteMelody->constructTune(CWavetableOscillator(Waveform::sine, 440, 1, fSampleRate), pawnNotes, pawnBeats, 4, 180);
	PawnBlackMelody->constructTune(CWavetableOscillator(Waveform::saw, 440, 1, fSampleRate), pawnNotes, pawnBeats, 4, 180);
	...
	auto AlarmSound = std::make_unique<CWavetableOscillator>(Waveform::sqr, 700, 1.0, fSampleRate);
	...
	mBass->constructTune(CWavetableOscillator(Waveform::sine, 440, 1, fSampleRate), bassNotes, bassBeats, 3, mBpm);
	...
	chord1->constructChord(CWavetableOscillator(Waveform::sine, 440, 1, fSampleRate), std::vector<std::string>{"A4", "C5", "E5"}, 12, mBpm);

	auto chord2 = std::make_unique<CScheduler>(fSampleRate);
	chord2->constructChord(CWavetableOscillator(Waveform::sine, 440, 1, fSampleRate), std::vector<std::string>{"A4", "D5", "F#5"}, 12, mBpm);
	...
	mMelodyL->constructTune(CWavetableOscillator(Waveform::saw, 440, 1, fSampleRate), melody1Notes, melody1Beats, 5, mBpm);
	...
	mMelodyR->constructTune(CWavetableOscillator(Waveform::saw, 440, 1, fSampleRate), melody2Notes, melody2Beats, 5, mBpm);
