...
void StorySonifier::initializeMemberInstruments(float fSampleRate)
{
        ...
        float kingBpm = 100;
        KingWhiteChord1->constructChord(CWavetableOscillator(Waveform::sine, 440, 1, fSampleRate), KingNotes, 0.5, kingBpm);
        KingWhiteChord2->constructChord(CWavetableOscillator(Waveform::sine, 440, 1, fSampleRate), KingNotes, 1, kingBpm);
        KingBlackChord1->constructChord(CWavetableOscillator(Waveform::saw, 440, 1, fSampleRate), KingNotes, 0.5, kingBpm);
        KingBlackChord2->constructChord(CWavetableOscillator(Waveform::saw, 440, 1, fSampleRate), KingNotes, 1, kingBpm);
		...
		BishopWhiteLoop->constructTune(CWavetableOscillator(Waveform::sine, 440, 1.0, fSampleRate), bishopNotes, bishopBeats, 5, bishopBpm);
		BishopBlackLoop->constructTune(CWavetableOscillator(Waveform::saw, 44, 1, fSampleRate), bishopNotes, bishopBeats, 5, bishopBpm);
        ...
        PawnWhiteMelody->constructTune(CWavetableOscillator(Waveform::sine, 440, 1, fSampleRate), pawnNotes, pawnBeats, 3, pawnBpm);
        PawnBlackMelody->constructTune(CWavetableOscillator(Waveform::saw, 440, 1, fSampleRate), pawnNotes, pawnBeats, 3, pawnBpm);
